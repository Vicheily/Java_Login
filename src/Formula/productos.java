...
public class productos extends javax.swing.JFrame {
 private final Cls_Productos CP;
    ...
    private void initComponents() {
        ...
        jLabel1.setText("CÃ³digo de Producto *");
        ...
        jLabel3.setText("Llene la informaciÃ³n respectiva de los productos.");
    ...
    private void bt_eliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bt_eliminarActionPerformed
        ...
        if (fila < 1){
            ...
            int resp = JOptionPane.showConfirmDialog(null, "Â¿EstÃ¡ seguro que desea eliminar?","Eliminar Producto", JOptionPane.OK_CANCEL_OPTION, JOptionPane.QUESTION_MESSAGE);
            if(resp==0){
