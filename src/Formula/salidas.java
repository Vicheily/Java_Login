...
public class salidas extends javax.swing.JFrame {
 private final Cls_Salida CP;
    ...
    private void guardar(){
        ...
        if(cantidad > stock){
            JOptionPane.showMessageDialog(null, "Â¡No hay stock suficiente!");
            txt_cantidad.setText("");
    ...
    private void initComponents() {
        ...
        jLabel1.setText("NÃºmero de Factura *");
        ...
        jLabel3.setText("DescripciÃ³n del Producto *");
        ...
        jLabel7.setText("Llene la informaciÃ³n respectiva para la salida de los productos.");
    ...
    private void jbt_buscarActionPerformed(java.awt.event.ActionEvent evt) {
        enviar = 1;
